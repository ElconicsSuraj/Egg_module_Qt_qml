    ...
    ColumnLayout {
        ...
        GridLayout {
            ...
            Repeater {
                ...
                delegate: Rectangle {
                    Layout.fillWidth: true; Layout.preferredHeight: 60 * scaleFactor; radius: 10 * scaleFactor
                    color: modelData === "?" ? "#b71c1c" : "#333"
                    Text { anchors.centerIn: parent; text: modelData; color: "white"; font.pixelSize: 22 * scaleFactor; font.bold: true }
                    MouseArea {
                        anchors.fill: parent
                        onClicked: {
        ...
        Rectangle {
            Layout.fillWidth: true; Layout.preferredHeight: 60 * scaleFactor; radius: 10 * scaleFactor
            color: "#4fc3f7"
            Text { anchors.centerIn: parent; text: "START"; color: "black"; font.pixelSize: 18 * scaleFactor; font.bold: true }
